...
- 开源地址：[https://github.com/go-gorm/gorm](https://link.zhihu.com/?target=https%3A//github.com/go-gorm/gorm)
- 中文教程：[https://gorm.io/zh_CN/docs/](https://link.zhihu.com/?target=https%3A//gorm.io/zh_CN/docs/)
...
- 通过 [gorm.Config](https://zhida.zhihu.com/search?content_id=235243154&content_type=Article&match_order=1&q=gorm.Config&zhida_source=entity) 完成 db 有关的自定义配置
...
## 2.1 [gorm.Model](https://zhida.zhihu.com/search?content_id=235243154&content_type=Article&match_order=1&q=gorm.Model&zhida_source=entity)
...
![img](https://pic1.zhimg.com/v2-648a0a769facdd35ba92bcf62a9cf82e_1440w.jpg)

在设定字符集时，建议使用 uft8mb4 替代 utf8，这样能支持更广泛的字符集，包括表情包等特殊字符的存储

![img](https://picx.zhimg.com/v2-a4122dff9d2b3f5a095e44f3bfa1f925_1440w.jpg)
...
在 mysql 中有一种特殊的列类型——json. 针对 json 类型的列执行更新操作时，可以使用 [http://gorm.io/datatypes](https://link.zhihu.com/?target=http%3A//gorm.io/datatypes) lib 包中封装的相关方法：
