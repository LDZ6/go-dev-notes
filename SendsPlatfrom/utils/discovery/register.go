...
type Register struct {
	...
	Username    string
	Password    string
	// closeCh is a channel used to signal the closure of a process or routine.
	// It is typically used to gracefully shut down operations by notifying
	// goroutines to stop execution.
	closeCh     chan struct{}
